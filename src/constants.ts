...
} from './abis/routerContracts.json'
...
export const STAKING_REWARDS_FACTORY_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.HARMONY]: '0xa26bD6052dbb86233465A01cA0518C6e62eEb9c0',
  [ChainId.HARMONY_TESTNET]: '0x15b61cc2ac17e9826277b3ff41aa2644a774daab',
}

export const INIT_CODE_HASH = '0x9581e528eb0adcac236019c89f3122ac5d5e52ea5564f68687eac0251d6e9daa'
